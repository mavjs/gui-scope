# backends/macos.py — process-scoped macOS AX shim
#
# deps:
...
from .base import GUIScopeBackend


class MacOSBackend(GUIScopeBackend):
    """
    ...
    def __init__(self, app_name: str, auto_launch: bool = True, timeout: int = 30, launch_cmd: str | None = None):
        # launch_cmd is a Linux-only concept (see backends/linux_common.py); ignored here.
